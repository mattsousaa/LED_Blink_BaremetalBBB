...
//SOC_CM_WKUP_REGS modulo 0
void setCLKModule0(CKM_MODULE_REG module, unsigned int value){
   	if(module == CM_WKUP_GPIO0_CLKCTRL){
      		unsigned int addr_temp = SOC_CM_WKUP_REGS + module;    // clock module base + module offset, TRM 2.1 & 8.1.12.1
		HWREG(addr_temp) |= value;
   	}
}
